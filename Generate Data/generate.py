...
for i in range(10000):
    ...
    pincode = getPincode()
    state = getState()
    data.append([uniqId, fName, lName, dob, phone, email, pincode, state, exp, spez, edu])

dataFrame = pd.DataFrame(data, columns=['MRN Number', 'First Name', 'Last Name', 'DOB', 'Phone Number',
                                        'Email', 'Pincode', 'State', 'Years of Exp.',
